...
// Detect YouTube search result URLs generated by the URL sanitizer
function isYouTubeSearchUrl(url: string): boolean {
  return url.includes('youtube.com/results?search_query=');
}

// Extract human-readable query from a YouTube search URL
function extractYouTubeSearchQuery(url: string): string {
  try {
